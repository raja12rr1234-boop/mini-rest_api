...
import com.ecoooo.eco.com.ma.exception_halding.ResourceNotFoundException;
...
public class Serviceimplimentation implements Serviceinterface {
    ...
    private final Mapperrr mapperrr ;
    ...
    public Responsee delete(int id) {
        Product product = productRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("product is double" + id));
